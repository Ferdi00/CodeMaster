    ...
    description: (
      <div>
        <p>
          ...
          interfacce grafiche, amministrazione di sistema, calcolo scientifico e
          numerico, database, giochi, grafica 3D, eccetera.<br></br>
          <br></br>
        ...
        <p>
          Per il download e l'istallazione vai alla pagina:{" "}
